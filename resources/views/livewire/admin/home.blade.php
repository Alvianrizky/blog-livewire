                    ...
                    <div class="row">
                        <div class="col-12 row">
                            ...
                            <div class="col-auto mx-2 bg-primary text-light rounded p-4" style="width: 300px;">
                                <div class="row">
                                    <div class="col-6">
                                        <h1 class="text-light"><strong>100</strong></h1>
                                    ...
                                    <div class="col-12 text-center mt-2">
                                        <a href="{{ route('post.index') }}" class="stretched-link text-light">More Info <i class="fas fa-arrow-right ml-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-auto mx-2 bg-success text-light rounded p-4" style="width: 300px;">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center mt-2">
                                        <a href="{{ route('tag.index') }}" class="stretched-link text-light">More Info <i class="fas fa-arrow-right ml-2"></i></a>
                                    </div>
                                </div>
                            </div>

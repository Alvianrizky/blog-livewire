<x-blog-layout>
    <div>
        ...
        <div class="row justify-content-center">
            <div class="row justify-content-center col-xl-10">
                <div class="row col-sm-12 col-md-12 col-lg-8 d-flex justify-content-center">
                    <div class="card-blogs m-2">
                        <div class="card-blogs-image">
                            <img src="{{ asset('img/post-2.jpg') }}" alt="gambar">
                        </div>
                        <div class="mt-3">
                            <p class="text-muted">15 Februari 2022</p>
                        </div>
                        <div class="text-blog">
                            <h4 class="fw-bolder">Judul Artikel Panjang Apa Aja</h4>
